...
public class PanelInsertar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/insertarbtn.jpg"))); // NOI18N
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 320, 130, 40));
        ...
        add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 80, 200, -1));

        jTextField2.setBackground(new java.awt.Color(204, 255, 204));
        add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 120, 200, -1));

        jTextField3.setBackground(new java.awt.Color(204, 255, 204));
        add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 160, 200, -1));

        jTextField4.setBackground(new java.awt.Color(204, 255, 204));
        add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 200, 200, -1));

        jTextField5.setBackground(new java.awt.Color(204, 255, 204));
        add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 240, 200, -1));

        jTextField6.setBackground(new java.awt.Color(204, 255, 204));
        add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 280, 200, -1));
        ...
        add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 320, 90, 40));

        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/limpiarbtn.jpg"))); // NOI18N
        add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 320, 110, 40));
