...
public class VentanaPrincipal extends javax.swing.JFrame {
     ...
     * Contiene métodos para mostrar diferentes paneles dentro de la ventana.
     */
    // Declaración de variables para los paneles de la aplicación
    ...
    // Métodos getter para acceder a los paneles
    ...
    public PanelEditar getpEditar() {
     ...
     /**
     * Constructor de la clase VentanaPrincipal, inicializa la ventana y los paneles.
     */
    public VentanaPrincipal() {
        setTitle("Papas nativas Colombianas");
        setResizable(false); // Hace que la ventana no sea redimensionable
        initComponents(); // Inicializa los componentes de la interfaz
        showMenu(); // Muestra el panel de menú por defecto

        // Inicialización de los paneles de la aplicación
    ...
    // End of variables declaration//GEN-END:variables
     ...
     // Método para mostrar el panel de menú en la ventana
    ...
    //Métodos para mostrar diferentes paneles en la ventana.
